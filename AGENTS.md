...
- Bootstrapping Init System: `includes/application_top.php` constructs an InitSystem that reads autoloader configurations frofm `includes/auto_loaders/` and then runs them from `includes/init_includes/` and plugin-provided loaders. 
